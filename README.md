...
- **Today (`/today`)**: Tick boxes for medication (Dexamphetamine (3x daily), Bupropion), lunch (counted items like eggs with quantity), smoothie ingredients (manual + auto-suggested from repeated smoothie notes, with optional gram weights), afternoon snack, water (goal + quick add/undo), workout, walk. Daily summary with calm, non-judgmental copy.

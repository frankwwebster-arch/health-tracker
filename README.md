...
- **Today (`/today`)**: Tick boxes for medication (Dexamphetamine (3x daily), Bupropion), lunch, smoothie ingredients (manual + auto-suggested from repeated smoothie notes), afternoon snack, water (goal + quick add/undo), workout, walk. Optional Peloton sync to auto-populate workout minutes. Daily summary with calm, non-judgmental copy.
